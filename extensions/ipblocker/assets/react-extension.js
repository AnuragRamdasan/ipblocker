              ...
              !(async function () {
                try {
                  const e = window.Shopify.shop,
                    ...
                    { ip: u } = await t(ee),
                    s = await t("".concat(te, "/").concat(u, "/json/")),
                    c = s.country_code,
                    f = { city: s.city, pincode: s.postal || s.zip },
                    d = r.map((e) => e.country_code),
                    p = (e) => {
                  ...
                  let m = !1,
                    g = "";
                  if (
                    ((null != i && i.length && !i.includes(c)) || d.includes(c)
                      ? ((m = !0), (g = "country"))
                      : p(f)
                        ? ((m = !0), (g = "city"))
                        : o.includes(u) && ((m = !0), (g = "ip")),
                    m)
                  ) {
                    try {
                      n(a, s, "".concat(g, "_blocked"));
                    } catch (e) {
