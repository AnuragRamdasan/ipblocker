      ...
      551: (e, t, n) => {
        ...
        function Bo() {
          if (!Ho && null !== Ao) {
            ...
            try {
              ...
              throw (null !== Ao && (Ao = Ao.slice(e + 1)), Qe(Ze, Bo), t);
            } finally {
              (bt = t), (Ho = !1);
            }
          }
        ...
        var Yi = {
          ...
          Zi = {
            ...
            useImperativeHandle: function (e, t, n) {
              return (
                (n = null != n ? n.concat([e]) : null),
                Ri(4194308, 4, Ai.bind(null, t, e), n)
              );
            },
        ...
        var ol = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (a.payload = t),
              null != n && (a.callback = n),
              null !== (t = Ua(e, a, o)) && (ns(t, e, o, r), Ha(t, e, o));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (o.tag = 2),
              null != t && (o.callback = t),
              null !== (t = Ua(e, o, r)) && (ns(t, e, r, n), Ha(t, e, r));
          },
        };
        ...
        var yl = w.ReactCurrentOwner,
          bl = !1;
        function wl(e, t, n, r) {
          t.child = null === e ? _a(t, null, n, r) : ka(t, e.child, n, r);
        }
        ...
        function Ml(e, t, n) {
          ...
          if (null !== (i = e.memoizedState) && null !== (r = i.dehydrated))
            return (function (e, t, n, r, o, i, l) {
              if (n)
                return 256 & t.flags
                  ? ((t.flags &= -257), Al(e, t, l, (r = cl(Error(a(422))))))
              ...
              if ("$!" === o.data) {
                if ((r = o.nextSibling && o.nextSibling.dataset))
                  var u = r.dgst;
                return (
                  (r = u), Al(e, t, l, (r = cl((i = Error(a(419))), r, void 0)))
                );
              }
              if (((u = !!(l & e.childLanes)), bl || u)) {
                ...
                return ms(), Al(e, t, l, (r = cl(Error(a(421)))));
              }
              return "$?" === o.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
              ...
              if (((n = t.type), null !== e && null != t.stateNode))
                ...
                if (((e = Xa(Va.current)), da(t))) {
                  ...
                  switch (((r[po] = t), (r[ho] = i), (e = !!(1 & t.mode)), n)) {
                    ...
                    case "video":
                    case "audio":
                      for (o = 0; o < Fr.length; o++) Ar(Fr[o], r);
                      break;
                    case "source":
                      Ar("error", r);
                      break;
              ...
              switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ro(ks.bind(null, e, Uu, Bu), t);
                    break;
                  }
                  ks(e, Uu, Bu);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = ro(ks.bind(null, e, Uu, Bu), r);
                    break;
                  }
                  ks(e, Uu, Bu);
                  break;
        ...
        function ss(e, t) {
          ...
          try {
            ...
            0 === (Ou = n) && ((qu = Ge() + 500), Uo && Bo());
          }
        }
        function cs(e) {
          null !== Ju && 0 === Ju.tag && !(6 & Ou) && _s();
          var t = Ou;
          Ou |= 1;
          var n = Tu.transition,
            r = bt;
        ...
        function qs(e, t, n, r, o, a, i, l, u) {
          return (
            ...
            (n = e.current),
            ((a = Aa((r = es()), (o = ts(n)))).callback = null != t ? t : null),
            Ua(n, a, o),
            (e.current.lanes = o),
            vt(e, o, r),
            rs(e, r),
        ...
        function Bs(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Ua(o, t, i)) && (ns(e, o, i, a), Ha(e, o, i)),
            i
          );
        }
        function $s(e) {
      ...
      287: (e, t) => {
        ...
        function E(e, t, r) {
          ...
          if (null != t)
            ...
            t))
              _.call(t, o) && !x.hasOwnProperty(o) && (a[o] = t[o]);
            ...
            (e = {
              ...
              403: (e, t, n) => {
                ...
                var r = n(562),
                  ...
                  h = n(303);
                function m(e, t) {
                  (this.options = o.handleOptions(_, e, null, i)),
          ...
          (t.unstable_scheduleCallback = function (e, o, a) {
            ...
            return (
              ...
              a > i
                ...
                : ((e.sortIndex = l), n(s, e), m || h || ((m = !0), R(_))),
              e
            );
          }),
  ...
  (o.m = n),
    ...
    (() => {
      ...
      var M = "debug",
        j = "error",
        A = "critical",
        U = C(C(C(C(C({}, M, 1), "info", 2), "warn", 3), j, 4), A, 5);
      function H(e, t) {
      ...
      const G = {
        ...
        Y = "https://appapi.heymantle.com/v1/usage_events",
        Z = "https://ipblocker.valuecommerce.info/countries",
        ee = "https://api.ipify.org?format=json",
        te = "https://api.ipapi.com",
        ne = () => {
          const t = async function (e) {
              ...
              try {
                ...
                if (!t.ok) throw new Error("Network response was not ok " + e);
                return await t.json();
              } catch (a) {
                if (0 === r) throw a;
                return (
            ...
            n = async (e, n, r) => {
              const { appId: o, customerToken: a } = e,
                {
                  ip: i,
                  continent_code: l,
                  continent_name: u,
              ...
              return (
                r.includes("blocked") && (y.blockedReason = r.split("_")[0]),
                t(Y, {
                  method: "POST",
                  headers: {
                    "Content-Type": "application/json",
                    "X-Mantle-App-Id": o,
                    "X-Mantle-Customer-Api-Token": a,
                  },
                  body: JSON.stringify({
                    eventId: "block_".concat(Date.now()),
                    eventName: r,
                    timestamp: Date.now(),
                    properties: y,
                  }),
            ...
            (0, e.useEffect)(() => {
              !(async function () {
                try {
                  const e = window.Shopify.shop,
                    {
                      ...
                      cities: u,
                      config: s,
                    } = await t("".concat(Z, "?shop=").concat(e)),
                    { ip: c } = await t(ee),
                    f = await t(
                      ""
                        .concat(te, "/")
                        .concat(
                          c,
                          "/?access_key=a9b7a2dccfd7659f52c7414083b297da&output=json",
                        ),
                    ),
                    d = f.country_code,
                    p = { city: f.city, pincode: f.postal || f.zip },
                    h = o.map((e) => e.country_code),
                    m = l.map((e) => e.country_code),
                    g = (e) => {
                      const { city: t, pincode: n } = e;
                      return v.some((e) =>
                        e.pincode
                          ? n === e.pincode
                    ...
                    v = u.map((e) => {
                      ...
                      return { city: t, pincode: n };
                    });
                  try {
                    await n(i, f, "ip_tracked");
                  } catch (e) {
                    console.error("Error tracking IP event:", e);
                  }
                  let y = !1,
                    b = "";
                  if (
                    ((null != l && l.length && !m.includes(d)) || h.includes(d)
                      ? ((y = !0), (b = "country"))
                      : g(p)
                        ? ((y = !0), (b = "city"))
                        : a.includes(c)
                  ...
                  console.error("Error fetching countries or IP data:", e);
                }
              })();
            }, []),
      ...
      t
        ...
        .render((0, K.jsx)(e.StrictMode, { children: (0, K.jsx)(ne, {}) })),
        re();
    })();
})();
